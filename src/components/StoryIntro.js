  ...
  return (
    <>
      ...
      <div className="flex-col items-center justify-center uploadStories-container gradientBackground fixed z-40 h-screen w-screen">
        <div className="text-xl fixed w-screen top-16  pr-[3.7rem]">
          ...
          <div className="text-2xl px-8">
            ...
            <p className="font-serif py-2">
              In the middle of June 2013, I was born in Droemling, Germany. I received a backpack from humans after my first four weeks of existence, and it is still on my back.aHello I’m Jonas. I’m a white stork with a backpack, and this is my story. Hope my story helps you to imagine being me. Here is my story:{" "}
            </p>
